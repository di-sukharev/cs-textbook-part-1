...
/**
 * Created by xuchen on 11/3/14. Translates VM commands into HACK assembly code
 */
public class CodeWriter {
	 ...
	 * main program should process all the .vm files in this directory. In doing so,
	 * it should use a separate Parser for handling each input file and a single
	 * CodeWriter for handling the output.”
	 *
	...
	/**
	 * Write the assembly code that is the translation of the given command where
	 * the command is either PUSH or POP
	 * 
	...
	/**
	 * Write assembly code that effects the VM initialization also called BOOTSTRAP
	 * CODE. This code must be placed at the beginning of the output file
	 */
	...
	/**
	 * assembly code template for return command use R13 for FRAME R14 for RET
	 * 
	 * @return
	 */
	public String returnTemplate() {
		...
		return "@LCL\n" + "D=M\n" + "@R11\n" + "M=D\n" + "@5\n" + "A=D-A\n" + "D=M\n" + "@R12\n" + "M=D\n"
				+ popTemplate1("ARG", 0, false) + "@ARG\n" + "D=M\n" + "@SP\n" + "M=D+1\n" + preFrameTemplate("THAT")
				+ preFrameTemplate("THIS") + preFrameTemplate("ARG") + preFrameTemplate("LCL") + "@R12\n" + "A=M\n"
				+ "0;JMP\n";
	}
